"""Validação: reproduzir o caso de estudo 2 (prótese da anca) de Petković et al. 2025.
...
pytestmark = pytest.mark.skip(reason="preencher com os dados publicados no artigo")


def test_hip_case_topsis_ranking():
    ...
